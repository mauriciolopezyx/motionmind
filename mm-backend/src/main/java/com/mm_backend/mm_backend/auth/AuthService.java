package com.mm_backend.mm_backend.auth;

import com.mm_backend.mm_backend.auth.dto.*;
import com.mm_backend.mm_backend.email.EmailService;
import com.mm_backend.mm_backend.user.User;
import com.mm_backend.mm_backend.user.UserRepository;
...
class AuthService {
    ...
    public void sendVerificationEmail(User user) {
        ...
        String htmlMessage = "<html>"
                ...
                + "<h2 style=\"color: #333;\">Welcome to MotionMind</h2>"
